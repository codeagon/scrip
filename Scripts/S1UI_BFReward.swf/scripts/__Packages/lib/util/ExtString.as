class lib.util.ExtString
{
   ...
   static function textCut(textFd, str)
   {
      ...
      if(!textFd.multiline)
      {
         _loc7_ = _loc3_.ascent + _loc3_.descent + _loc3_.leading;
         var _loc11_ = textFd._width - 2;
         _loc5_ = textFd.getCharIndexAtPoint(_loc11_,_loc7_);
      }
      else
      {
         _loc7_ = _loc3_.ascent + _loc3_.descent + _loc3_.leading;
         _loc9_ = int(textFd._height / _loc7_);
         var _loc10_ = textFd.getLineMetrics(_loc9_ - 1);
         var _loc8_ = textFd._width - _loc10_.width - 2;
         _loc8_ = Math.abs(_loc8_);
         var _loc12_ = textFd.getLineOffset(_loc9_);
         _loc5_ = textFd.getCharIndexAtPoint(_loc8_,textFd._height);
      }
      textFd.isTextCut = true;
      lib.manager.ToolTip.remove(textFd);
      if(_loc6_ > _loc5_ && _loc5_ != -1)
      {
         if(_loc6_ > _loc5_ + 2)
         {
            textFd.replaceText(_loc5_ - 2,_loc6_,"…");
            if(arguments[2])
            {
               if(!textFd.html)
               {
