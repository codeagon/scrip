class lib.controls.CustomScaleEvent
{
   ...
   function scaleHandler(value)
   {
      ...
      _loc4_ = _root.GetRegisterUIData(this.UIName);
      ...
      var _loc7_ = lib.info.AlignInfo.uiScaleLimit(_loc5_ / 100);
      _loc5_ = _loc8_ = _loc7_ * 100;
      if(_loc4_.PA == "1")
      {
         this.axis._xreg = 0;
         this.axis._yreg = 0;
      ...
      this.axis.setYscale(this.UI,_loc8_);
   ...
   {
      this.customizeData.removeEventListener(gfx.events.EventTypes.VALUE_CHANGE,this._instance,"valueChangeHandler");
   }
}
