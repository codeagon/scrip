class com.bluehole.tera.view.core.ActionBarSlot extends gfx.controls.ItemSlot implements gfx.interfaces.IListItemRenderer
{
   ...
   {
      return (com.bluehole.tera.view.core.SlotButton)this.button.__get__playCoolTimeEffect();
   }
   ...
   function configUI()
   {
      ...
      (com.bluehole.tera.view.core.SlotButton)this.button.setBitmapName(this.bitmapName);
   }
   function draw()
   {
      super.draw();
      if(this.dataChanged)
      {
         ...
         if(this._data)
         {
            if(this.icon.__get__TEX() && this.icon.__get__TEX() != "")
            {
               ...
               (com.bluehole.tera.view.core.SlotButton)this.button.__set__playCoolTimeEffect(!this._data.playCoolTimeEffect?0:this._data.playCoolTimeEffect);
            }
         }
         else
         {
