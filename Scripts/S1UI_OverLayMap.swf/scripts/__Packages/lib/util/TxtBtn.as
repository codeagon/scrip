class lib.util.TxtBtn
{
   ...
   function setRollOver(func)
   {
      this.btn.onRollOver = function()
      {
         ...
         this.o.txt.shadowBlurX = 5;
         this.o.txt.shadowBlurY = 5;
         this.o.txt.shadowStrength = 1;
         this.o.txt.shadowDistance = 0;
         this.o.txt.shadowAngle = 45;
   ...
   function setRollOut(func)
   {
      this.btn.onRollOut = function()
      {
         ...
         this.o.txt.shadowBlurX = 0;
         this.o.txt.shadowBlurY = 0;
         this.o.txt.shadowStrength = 0;
         this.o.txt.shadowDistance = 0;
         this.o.txt.shadowAngle = 45;
   ...
   function setPress(func)
   {
      this.btn.onPress = function()
      {
         ...
         this.o.txt.shadowBlurX = 6;
         this.o.txt.shadowBlurY = 6;
         this.o.txt.shadowStrength = 1;
         this.o.txt.shadowDistance = 0;
         this.o.txt.shadowAngle = 45;
