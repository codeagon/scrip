class lib.util.CoolTimeInstance extends MovieClip
{
   ...
   function getCountText()
   {
      ...
      {
         return Math.floor(_loc2_ / 60) + lib.util.CoolTimeInstance.STR_MINUTE;
      }
      if(_loc2_ > 3600 && _loc2_ <= 86400)
      {
         return Math.floor(_loc2_ / 3600) + lib.util.CoolTimeInstance.STR_HOUR;
      }
      if(_loc2_ > 86400)
      {
         return Math.floor(_loc2_ / 86400) + lib.util.CoolTimeInstance.STR_DAY;
      }
   }
