class lib.gamedata.GameDataCollectionImpl implements mx.utils.Iterator, lib.gamedata.GameDataCollection
{
   ...
   function addData(data)
   {
      ...
      if(this.checkValidData(data))
      {
         ...
         else
         {
            ...
            _loc2_ = true;
            this.dispatchEvent({type:lib.gfx.events.EventTypes.ADD,target:data,data:data,id:data.getId()});
         }
      }
      return _loc2_;
   }
   ...
   function removeData(id)
   {
      ...
      if(_loc4_ != null)
      {
         this.dispatchEvent({type:lib.gfx.events.EventTypes.REMOVE,target:_loc3_,data:_loc3_,id:_loc3_.getId()});
   ...
   function clear()
   {
      ...
      while(_loc3_.hasNext())
      {
         ...
         this.dispatchEvent({type:lib.gfx.events.EventTypes.REMOVE,target:_loc2_,id:_loc2_.getId()});
      }
      this.dispatchEvent({type:lib.gfx.events.EventTypes.CLEAR,target:null});
