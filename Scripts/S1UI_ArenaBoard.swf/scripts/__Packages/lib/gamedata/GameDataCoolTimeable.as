class lib.gamedata.GameDataCoolTimeable implements lib.gamedata.GameData
{
   ...
   {
      lib.gfx.events.EventDispatcher.initialize(this.eventDispatcher = new Object());
      this.setId(id);
   }
   function getId()
   {
   ...
   function createCoolTimeEvent()
   {
      ...
      {
         thisObject.dispatchEvent({type:lib.gfx.events.EventTypes.COOLTIME_END,target:thisObject});
         thisObject.removeCoolTime();
      };
      this.coolTime.onStart = function()
      {
         thisObject.dispatchEvent({type:lib.gfx.events.EventTypes.COOLTIME_START,target:thisObject});
      };
      this.coolTime.onTick = function()
      {
         thisObject.dispatchEvent({type:lib.gfx.events.EventTypes.COOLTIME_TICK,target:thisObject});
      };
      this.coolTime.onUpdate = function()
      {
         thisObject.dispatchEvent({type:lib.gfx.events.EventTypes.COOLTIME_UPDATE,target:thisObject});
      };
   }
