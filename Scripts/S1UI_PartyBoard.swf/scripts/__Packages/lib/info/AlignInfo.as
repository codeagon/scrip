class lib.info.AlignInfo
{
   ...
   static function savePos(ui, lockState, optionCustomX, optionCustomY)
   {
      ...
      {
         _loc6_ = Number(_loc3_.ScaleCustom) / Number(lib.gamedata.DefaultData.getDefaultUIData("uiscale").param0);
      }
      var _loc8_ = lib.info.AlignInfo.uiScale(ui._name,ui);
      var _loc7_ = lib.info.AlignInfo.uiScaleLimit(lib.info.AlignInfo.scaleRatio * _loc8_) * _loc6_;
      if(_loc3_.PA == 1)
      {
      }
      if(_loc3_.PA == 2)
      {
         _loc5_ = _loc5_ + ui.hit._width / 2;
      }
      if(_loc3_.PA == 3)
      {
         _loc5_ = _loc5_ + ui.hit._width;
      }
      if(_loc3_.PA == 4)
      {
         _loc4_ = _loc4_ + ui.hit._height / 2;
      }
      else if(_loc3_.PA == 5)
      {
         _loc5_ = _loc5_ + ui.hit._width / 2;
      ...
      _loc5_ = _loc5_ * (lib.info.AlignInfo.onePixelPercentW * _loc7_);
      _loc4_ = _loc4_ * (lib.info.AlignInfo.onePixelPercentH * _loc7_);
