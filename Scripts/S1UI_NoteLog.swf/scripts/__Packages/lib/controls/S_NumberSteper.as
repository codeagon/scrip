class lib.controls.S_NumberSteper extends MovieClip
{
   ...
   function S_NumberSteper()
   {
      ...
      this.max_mc.onPress = function()
      {
         getURL("FSCommand:ToGame_PlaySound",1008);
         trace("ToGame_PlaySound   1008");
         var _loc1_ = _this.ext_textField.max;
         _this.ext_textField.text = _loc1_;
      ...
      this.min_mc.onPress = function()
      {
         getURL("FSCommand:ToGame_PlaySound",1008);
         trace("ToGame_PlaySound   1008");
         var _loc1_ = _this.ext_textField.min;
         _this.ext_textField.text = _loc1_;
         _this.ext_textField.setChanged(true);
      };
   ...
   {
      var _loc2_ = this.intervalIds.pop();
      while(_loc2_ != undefined)
      {
         clearInterval(_loc2_);
         _loc2_ = this.intervalIds.pop();
      }
   }
   function addCount(size)
   {
      trace("addCount  " + size + "   " + this);
   ...
   function setPage(currentPage, totalPage)
   {
      ...
      this.ext_textField.__get__textField().textColor = currentPage < totalPage?lib.info.TextColor.FILL_SHORT:lib.info.TextColor.FILL_FULL;
