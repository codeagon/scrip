class lib.info.AlignInfo
{
   ...
   static function savePos(ui, lockState, optionCustomX, optionCustomY)
   {
      ...
      lib.Debuger.trace("============AlignInfo - savePos============");
      lib.Debuger.trace(ui._name + "이 AlignInfo를 통해 저장되었따!!");
      lib.Debuger.trace("LayoutManager를 통해 저장하도록 바꿔주자!!!");
      lib.Debuger.trace("===========================================");
      com.bluehole.tera.managers.LayoutManager.saveUIPositon(ui,_loc3_.PA,lockState,optionCustomX,optionCustomY);
   }
   static function savePosCustom(ui, lockState, xRatio, yRatio)
   {
      lib.Debuger.trace("============AlignInfo - savePosCustom=============");
      lib.Debuger.trace("savePosCustom은 사용하면 안된다. 찾아서 제거하자!!");
      lib.Debuger.trace("사용한 UI의 이름 : " + ui._name);
      lib.Debuger.trace("==================================================");
