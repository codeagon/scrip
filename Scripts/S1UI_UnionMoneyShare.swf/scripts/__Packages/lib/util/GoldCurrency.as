class lib.util.GoldCurrency
{
   ...
   static function SetTCatText(num1e)
   {
      var _loc1_ = "";
      var _loc2_ = "#FFC987";
      _loc1_ = "<font color=\'" + _loc2_ + "\'>" + lib.util.CurrencyFormat.makeComma(num1e) + "</font>" + "<img src=\'Tcat_token\' vspace=\'-1\'>";
      return _loc1_;
   }
}
