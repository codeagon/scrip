class com.bluehole.tera.control.LayoutActor extends gfx.core.UIComponent
{
   ...
   function setScaleRatio(scaleRatio)
   {
      ...
      {
         for(var _loc4_ in this.widget)
         {
            var _loc2_ = this.widget[_loc4_];
            if(_loc2_._parent && _loc2_._parent == this.widget)
            {
               this.setScale(_loc2_,scaleRatio);
            }
         }
      }
   }
   ...
   function setScale(target, scaleRatio)
   {
      ...
      lib.Debuger.trace("LayoutActor - setScale - " + this.__get__widgetName() + " : " + scaleRatio);
