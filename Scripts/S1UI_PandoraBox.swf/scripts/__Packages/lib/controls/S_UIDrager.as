class lib.controls.S_UIDrager extends mx.core.UIComponent
{
   ...
   function beginDrag()
   {
      ...
      var _loc3_ = lib.info.AlignInfo.uiScale(this.UIName);
      ...
      this.rightLimit = Stage.width - lib.info.AlignInfo.horizontalSpace + this.adjustRight * (lib.info.AlignInfo.scaleRatio * _loc3_);
      ...
      lib.Debuger.trace("rightLimit : " + this.rightLimit);
