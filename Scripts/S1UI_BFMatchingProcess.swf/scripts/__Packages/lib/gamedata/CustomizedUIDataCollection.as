class lib.gamedata.CustomizedUIDataCollection extends lib.gamedata.GameDataCollectionImpl
{
   ...
   function createDefaultDatas()
   {
      ...
      this.defaults.addData(new lib.gamedata.CustomizedUIData(lib.gamedata.CustomizedUIDataKey.CHARACTERHP_SHOW_PERCENT,0));
      this.defaults.addData(new lib.gamedata.CustomizedUIData(lib.gamedata.CustomizedUIDataKey.CHARACTERMP_SHOW_PERCENT,0));
