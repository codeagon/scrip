class lib.info.AlignInfo
{
   ...
   static var SCALE_GAGEBOSS_PERCENT = 100;
   static var SCALE_TARGETINFO_PERCENT = 100;
   function AlignInfo()
   {
   }
   ...
   static function uiScale(_uiname, _ui)
   {
      ...
      {
         _loc2_ = lib.info.AlignInfo.SCALE_EXTSHORTCUT2_PERCENT / 100;
      ...
      {
         _loc2_ = lib.info.AlignInfo.SCALE_DELIVERY_PERCENT / 100;
      ...
      else if(_uiname == "GAGEBOSS")
      {
         _loc2_ = lib.info.AlignInfo.SCALE_GAGEBOSS_PERCENT / 100;
         lib.info.AlignInfo.UISCALE_VARS = "SCALE_GAGEBOSS_PERCENT";
      }
      else if(_uiname == "TARGETINFO")
      {
         _loc2_ = lib.info.AlignInfo.SCALE_TARGETINFO_PERCENT / 100;
         lib.info.AlignInfo.UISCALE_VARS = "SCALE_TARGETINFO_PERCENT";
      }
      var _loc6_ = _root.GetRegisterUIData(_uiname);
      var _loc5_ = 1;
      if(_loc6_.ScaleCustom)
      {
         _loc5_ = Number(_loc6_.ScaleCustom) / Number(lib.gamedata.DefaultData.getDefaultUIData("uiscale").param0);
         _loc2_ = _loc2_ * _loc5_;
      }
      if(_ui != undefined)
      {
         if(_loc2_ >= 1.87 * _loc5_)
         {
            _loc2_ = 1.87 * _loc5_;
            lib.info.AlignInfo["SCALE_" + _uiname + "_PERCENT"] = _loc2_ * 100;
         }
         if(_loc2_ <= 0.63 * _loc5_)
         {
            _loc2_ = 0.63 * _loc5_;
