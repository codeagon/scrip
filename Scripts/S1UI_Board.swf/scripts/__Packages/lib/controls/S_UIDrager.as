class lib.controls.S_UIDrager extends mx.core.UIComponent
{
   ...
   function beginDrag()
   {
      var _loc4_ = lib.info.AlignInfo.uiScale(this.UIName,this.dragTarget_mc);
      var _loc3_ = lib.info.AlignInfo.scaleRatio * _loc4_;
      this.leftLimit = - lib.info.AlignInfo.horizontalSpace + this.adjustLeft * _loc3_;
      this.topLimit = - lib.info.AlignInfo.verticalSpace + this.adjustTop * _loc3_;
      this.rightLimit = Stage.width - lib.info.AlignInfo.horizontalSpace - this._width * _loc3_ + this.adjustRight * _loc3_;
      this.bottomLimit = lib.info.AlignInfo.UI_HEIGHT + lib.info.AlignInfo.verticalSpace - this._height * _loc3_ + this.adjustBottom * _loc3_;
