class lib.controls.S_SimpleScrollBar extends MovieClip
{
   ...
   function init()
   {
      ...
      this.upBtn.onRollOut = this.upBtn.onReleaseOutside = function()
      {
         this.gotoAndStop("up");
      };
      ...
      this.donwBtn.onRollOut = this.upBtn.onReleaseOutside = function()
      {
         this.gotoAndStop("up");
      };
   ...
   function draw()
   {
      ...
      this._scrollMax = Math.max(0,Math.round((this._pageSize - this._displaySize) / this._rowHeight));
   ...
   function __set__scroll(pscroll)
   {
      ...
      trace("  pscroll   " + pscroll + "  _scroll " + this.__get__scroll() + "  _scrollMax  " + this._scrollMax);
