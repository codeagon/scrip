class lib.util.ExtString
{
   ...
   static function textCut(textFd, str)
   {
      ...
      var _loc12_ = _loc11_.ascent + _loc11_.descent + _loc11_.leading;
      var _loc6_ = int(textFd._height / _loc12_);
      lib.Debuger.trace("textFd._height : " + textFd._height + ", textFd._width : " + textFd._width);
      lib.Debuger.trace("lineH : " + _loc12_);
      lib.Debuger.trace("endLineNum : " + _loc6_);
      var _loc13_ = String(textFd.text).length;
      var _loc9_ = textFd.getLineLength(_loc6_);
      lib.Debuger.trace("wrapLineIndex : " + _loc9_);
      var _loc3_ = 0;
      ...
      if(_loc9_ > 0)
      {
         if(_loc9_ > 2)
         {
            ...
            textFd.replaceText(_loc3_ - 1,_loc13_,"…");
            var _loc4_ = 0;
         ...
         {
            var _loc14_ = _loc3_ / (_loc3_ + _loc9_);
            textFd.fontScaleFactor = _loc14_;
            if(textFd.html)
            {
