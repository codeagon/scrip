class lib.controls.S_UIDrager extends mx.core.UIComponent
{
   ...
   function beginDrag()
   {
      ...
      this.rightLimit = Stage.width - lib.info.AlignInfo.horizontalSpace - lib.info.AlignInfo.DRAG_SAVESPACE + this.adjustRight * lib.info.AlignInfo.scaleRatio;
      this.topLimit = - lib.info.AlignInfo.verticalSpace + this.adjustTop * lib.info.AlignInfo.scaleRatio;
      this.bottomLimit = lib.info.AlignInfo.UI_HEIGHT + lib.info.AlignInfo.verticalSpace - lib.info.AlignInfo.DRAG_SAVESPACE + this.adjustBottom * lib.info.AlignInfo.scaleRatio;
