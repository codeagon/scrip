class g4.util.Translator
{
   ...
   static function convertSecond(second)
   {
      if(second <= 60)
      {
         return Math.ceil(second) + g4.util.Translator.secondText;
      }
      if(second <= 3600)
      {
         return Math.ceil(second / 60) + g4.util.Translator.minuteText;
      }
      if(second <= 86400)
      {
         return Math.ceil(second / 3600) + g4.util.Translator.hourText;
      }
      return Math.ceil(second / 86400) + g4.util.Translator.dayText;
   }
}
