class lib.info.AlignInfo
{
   ...
   static var SCALE_EXTSHORTCUT2_PERCENT = 100;
   ...
   static var SCALE_DELIVERY_PERCENT = 100;
   ...
   static function uiScale(_uiname, _ui)
   {
      ...
      else if(_uiname == "EXTSHORTCUT2")
      {
         _loc3_ = lib.info.AlignInfo.SCALE_EXTSHORTCUT2_PERCENT / 100;
         lib.info.AlignInfo.UISCALE_VARS = "SCALE_EXTSHORTCUT2_PERCENT";
      }
      ...
      else if(_uiname == "DELIVERY")
      {
         _loc3_ = lib.info.AlignInfo.SCALE_DELIVERY_PERCENT / 100;
         lib.info.AlignInfo.UISCALE_VARS = "SCALE_DELIVERY_PERCENT";
      }
