class g4.view.party.BuffSlot extends g4.core.SimpleView
{
   var COOLTIME_SIZE = 20;
   var COOLTIME_COLOR = 0;
   var COOLTIME_ALPHA = 75;
   var ICON_SIZE = 18;
   var warningVisible = false;
   var showCoolTimeText = false;
   ...
   function setData(data)
   {
      ...
      if(_loc4_)
      {
         ...
         {
            this.showCoolTimeText = false;
            this.setCoolTimeText("");
            this.mc_frame.gotoAndStop(1);
         }
         else
         {
            this.showCoolTimeText = true;
   ...
   {
      if(this.showCoolTimeText)
      {
         this.setCoolTimeText(this.coolTime.getRemainTimeText());
      }
      this.drawCoolTime(this.coolTime.getDegree());
      if(this.coolTime.getRemainTimeSecond() <= g4.view.party.PartyConstants.COOLTIME_WARNING_SEC)
      {
         this.startWarning();
      }
   }
