class g4.core.EventDispatcher
{
   ...
   static function indexOfListener(listeners, scope, callBack)
   {
      ...
      while((_loc2_ = _loc2_ + 1) < _loc3_)
      {
         ...
         if(_loc1_.scope == scope && _loc1_.listenerFunction == callBack)
         {
            return _loc2_;
         }
      }
   ...
   function addEventListener(eventType, scope, callBack)
   {
      ...
      if(g4.core.EventDispatcher.indexOfListener(this._listeners[eventType],scope,callBack) == -1)
      {
   ...
   function removeEventListener(eventType, scope, callBack)
   {
      ...
      var _loc3_ = g4.core.EventDispatcher.indexOfListener(_loc2_,scope,callBack);
      if(_loc3_ != -1)
      {
