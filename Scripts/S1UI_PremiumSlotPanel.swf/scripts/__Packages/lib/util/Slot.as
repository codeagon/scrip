class lib.util.Slot extends MovieClip
{
   ...
   {
      g4.util.Debug.log("lib.util.Slot.setData > data : " + data);
      this.clear();
   ...
   function init()
   {
      g4.util.Debug.log("lib.util.Slot.init");
   ...
   function clear()
   {
      g4.util.Debug.log("lib.util.Slot.clear");
      this.__set__New(0);
   ...
   function __set__active(bTrue)
   {
      ...
      this.isActive = bTrue;
      g4.util.Debug.log("[lib.util.Slot.active][o.effect] " + this.o.effect);
      if(this.o.effect)
      {
         g4.util.Debug.log("[lib.util.Slot.active][o.FX_ACTIVE._visible] " + this.o.FX_ACTIVE._visible);
         if(bTrue)
         {
            this.o.FX_ACTIVE._visible = true;
            g4.util.Debug.log("[lib.util.Slot.active][11] " + this.o.FX_ACTIVE._totalframes);
            g4.util.Debug.log("[lib.util.Slot.active][22] " + this.o.FX_ACTIVE._currentframe);
            if(this.o.FX_ACTIVE._totalframes != 1 && this.o.FX_ACTIVE._currentframe == 1)
            {
               this.o.FX_ACTIVE.gotoAndPlay(2);
               g4.util.Debug.log("[lib.util.Slot.active][o.FX_ACTIVE._visible] " + this.o.FX_ACTIVE._visible + ", o.FX_ACTIVE._alpha: " + this.o.FX_ACTIVE._alpha);
            }
         }
         else
         {
   ...
   {
      g4.util.Debug.log("effect : bTrue : " + bTrue);
   ...
   function onUnload()
   {
      g4.util.Debug.log("lib.util.Slot.onUnload");
      this.clear();
   }
