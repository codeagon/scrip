class g4.view.baseUI.BaseUI
{
   ...
   function announce()
   {
      var _loc38_ = lib.manager.UISound.UI_OPEN;
      var _loc35_ = lib.manager.Focus.bone();
      var _loc42_ = lib.info.TextColor.SLOT_NUMBER;
      var _loc39_ = lib.info.AlignInfo.xRatioToPixel(100);
      var _loc36_ = lib.info.ToolTipStr.CLOSE;
      var _loc48_ = lib.info.LoadURL.SERVER_SELECT_BG;
      var _loc45_ = lib.info.KeyMap.getKey(48);
      var _loc33_ = new lib.util.AxisResetter();
      var _loc31_ = new lib.util.TxtBtn();
      var _loc29_ = new lib.util.TxtAniBtn();
      var _loc25_ = new lib.util.TabBtn();
      var _loc20_ = new lib.util.McMaker();
      var _loc14_ = new lib.util.ExtTextField();
      var _loc26_ = lib.util.CurrencyFormat.makeComma("123");
      var _loc21_ = lib.util.ExtString.trimChar("abc123");
      var _loc15_ = lib.util.DrawBitmap.draw(this.s1.Icon,"img://__Icon_Skills.Jump_TEX",50,50);
      _loc15_ = lib.util.DrawBitmap.draw(this.s1.Icon,"img://__Icon_Items.blackdagger_TEX",50,50);
      var _loc9_ = lib.util.FrameSeeker.seek(this.s1,1,1);
      var _loc6_ = new lib.util.LbTxtBtn();
      var _loc46_ = lib.util.UIString.getUIString();
      var _loc43_ = new lib.util.List();
      var _loc44_ = new lib.util.CoolTime(1,1);
      var _loc40_ = new lib.util.Warning.init();
      var _loc37_ = lib.util.ColorUtil.RGBToHex(255,255,255);
      var _loc34_ = lib.util.ObjAlign.align();
      var _loc32_ = lib.util.GeneralTabBtn.test;
      var _loc30_ = lib.util.LockBtn.test;
      var _loc27_ = new lib.util.Slot3();
      var _loc22_ = lib.util.StrByteLen.getLenth2("aaa");
      var _loc16_ = lib.util.RGBColor.RGBToHexdecimal(255,0,0);
      var _loc28_ = new lib.util.Slot2.test();
      var _loc23_ = lib.util.AnimationGage.test;
      var _loc17_ = lib.util.Aligner.preLoadVar;
      var _loc10_ = lib.util.SlotInnerAttacher.preLoadVar;
      _loc10_ = new lib.controls.S_SortBtn();
      var _loc2_ = undefined;
      (lib.util.Snapper)_loc2_;
      (lib.util.SnapperGroup)_loc2_;
      (lib.util.InteractionGroup)_loc2_;
      (lib.gamedata.GameData)_loc2_;
      (lib.gamedata.GameDataCollection)_loc2_;
      (lib.gamedata.GameDataCollectionImpl)_loc2_;
      (lib.gamedata.GameDataCoolTimeable)_loc2_;
      (lib.gamedata.CustomizedUIData)_loc2_;
      (lib.gamedata.CustomizedUIDataKey)_loc2_;
      (lib.gamedata.Item)_loc2_;
      (lib.gamedata.Skill)_loc2_;
      (lib.gamedata.MapMarker)_loc2_;
      (lib.gamedata.QuestTaskData)_loc2_;
      (lib.gamedata.QuestTaskSubData)_loc2_;
      (lib.gamedata.QuestTaskDataCollection)_loc2_;
      (lib.gamedata.DefaultData)_loc2_;
      (lib.gamedata.HistoryData)_loc2_;
      (lib.src.QuestTaskMc)_loc2_;
      (lib.src.QuestTaskPartyMc)_loc2_;
      (lib.util.TextFieldFormatter)_loc2_;
      (lib.controls.S_NumberSteper2)_loc2_;
      (g4.view.ViewID)_loc2_;
      ...
      var _loc56_ = new lib.controls.S_SimpleScrollBar();
      var _loc50_ = new lib.controls.S_SimpleComboBox();
      var _loc49_ = new lib.controls.S_CheckBox();
      var _loc24_ = new lib.controls.S_NumberSteper();
      var _loc18_ = new lib.controls.S_TextScrollBar();
      _loc18_ = new lib.controls.S_Slider();
      var _loc11_ = lib.controls.S_UIDrager.test;
      var _loc7_ = lib.controls.AutoBuilder.test;
      var _loc3_ = lib.controls.S_2DepthList2.preLoadVar;
      var _loc57_ = lib.controls.S_2DepthList.preLoadVar;
      var _loc54_ = lib.controls.S_2DepthList_ForQuest.preLoadVar;
      var _loc51_ = new lib.controls.S_SimpleScrollBar_width();
      var _loc12_ = new lib.controls.CustomScaleEvent();
      var _loc47_ = lib.controls.S_DragScale.test;
      var _loc19_ = lib.controls.S_2DepthList_Help.preLoadVar;
      var _loc13_ = lib.controls.S_GoldCurrency.test;
      var _loc8_ = lib.util.GoldCurrency.test;
      var _loc4_ = lib.controls.S_GoldCurrencyInput.test;
      var _loc41_ = lib.controls.S_GoldCurrencyInputByAVG.test;
      var _loc58_ = lib.net.NetConnect.test;
      var _loc55_ = new lib.src.ClipBoardSrc(this._targetMovieClip);
      var _loc52_ = new lib.controls.S_TxtBtn2();
      var _loc53_ = lib.manager.PopupManager.getPopup(12345);
      var _loc5_ = lib.manager.ToolTip.clear();
   }
