class lib.util.Slot extends MovieClip
{
   ...
   function __set__durability(index)
   {
      ...
      if(_loc4_ == "paperdoll")
      {
         var _loc5_ = new flash.geom.Transform(this.o.Icon);
         var _loc2_ = undefined;
         ...
         {
            _loc2_ = lib.info.ColorTrans.slotDurability(this._durability);
         }
         _loc5_.colorTransform = _loc2_;
      }
      else
      {
         if(this._durability == 0 || this._durability == 1)
         {
            this.o.Icon._alpha = 100;
         }
         if(this._durability == 2)
         {
            this.o.Icon._alpha = 30;
         }
      }
