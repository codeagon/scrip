class com.bluehole.tera.managers.LayoutManager
{
   ...
   {
      var _loc4_ = com.bluehole.tera.managers.LayoutManager.getRatioPosition(ui,pivotType);
      var _loc3_ = optionCustomX == undefined?_loc4_.x:optionCustomX;
      var _loc2_ = optionCustomY == undefined?_loc4_.y:optionCustomY;
      lib.Debuger.trace("xRatio : " + _loc3_ + ", yRatio : " + _loc2_);
      _root.ToGame_SaveUIPosition(lockState,ui._name,_loc3_,_loc2_);
   ...
   static function getRatioPosition(ui, pivotType)
   {
      ...
      lib.Debuger.trace("uiCanvas : " + _loc4_);
      var _loc2_ = com.bluehole.tera.managers.LayoutManager.getOriginCoord(ui);
      lib.Debuger.trace("origin.x : " + _loc2_.x + ", origin.y : " + _loc2_.y);
      var _loc1_ = com.bluehole.tera.managers.LayoutManager.getPivotPoint(ui,pivotType);
      lib.Debuger.trace("pivotType : " + pivotType);
      lib.Debuger.trace("pivot.x : " + _loc1_.x + ", pivot.y : " + _loc1_.y);
      return new flash.geom.Point((ui._x + _loc1_.x - _loc2_.x) * 10000 / _loc4_._xscale / Stage.visibleRect.width,(ui._y + _loc1_.y - _loc2_.y) * 10000 / _loc4_._yscale / Stage.visibleRect.height);
   }
   ...
   static function getOriginCoord(ui)
   {
      ...
      var _loc1_ = {x:Stage.visibleRect.left,y:Stage.visibleRect.top};
      lib.Debuger.trace("origin.x : " + _loc1_.x + ", origin.y : " + _loc1_.y);
      _loc2_.globalToLocal(_loc1_);
      lib.Debuger.trace("globalToLocal origin.x : " + _loc1_.x + ", origin.y : " + _loc1_.y);
      return _loc1_;
   }
