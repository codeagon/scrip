class lib.controls.S_UIDrager extends gfx.core.UIComponent
{
   ...
   function endDrag()
   {
      ...
      if(this.__get__save())
      {
         var _loc4_ = this.lock_mc == undefined?1:this.lock_mc._currentframe - 1;
         var _loc3_ = _root.GetRegisterUIData(this.UIName);
         lib.Debuger.trace("UIdata : " + _loc3_ + ", UIdata.PA : " + _loc3_.PA);
         com.bluehole.tera.managers.LayoutManager.saveUIPositon(this.dragTargetUI,_loc3_.PA,_loc4_);
      }
