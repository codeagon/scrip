class g4.model.chat.ChatModel extends g4.model.Model
{
   ...
   function saveChatTabInfo()
   {
      ...
      var _loc2_ = undefined;
      var _loc3_ = undefined;
      var _loc4_ = this.chatTabDataArray.length;
      _loc3_ = 0;
      while(_loc3_ < _loc4_)
      {
         _loc2_ = this.chatTabDataArray[_loc3_];
         this.modelCalls.ToGame_Chat_SaveTabInfo(_loc2_.id,_loc2_.x,_loc2_.y,_loc2_.width,_loc2_.height,_loc2_.type);
         _loc3_ = _loc3_ + 1;
      }
