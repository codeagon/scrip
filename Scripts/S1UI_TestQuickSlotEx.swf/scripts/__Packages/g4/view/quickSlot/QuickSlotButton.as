class g4.view.quickSlot.QuickSlotButton extends gfx.controls.Button
{
   ...
   function toString()
   {
      return "[g4.view.quickSlot.QuickSlotButton " + this._name + "]";
   }
   function configUI()
   {
      super.configUI();
   ...
   function __set__playCoolTime(value)
   {
      ...
      var _loc2_ = Math.floor(g4.view.quickSlot.QuickSlotButton.COOL_TIME_TOTAL_FRAME * value / 100);
   ...
   function __set__playCoolTimeEffect(value)
   {
      ...
      this.coolTimeEffectMc.gotoAndStop(Math.floor(g4.view.quickSlot.QuickSlotButton.COOL_TIME_EFFECT_TOTAL_FRAME * value / 100));
