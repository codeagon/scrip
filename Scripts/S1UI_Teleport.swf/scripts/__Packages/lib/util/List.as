class lib.util.List implements mx.utils.Iterator
{
   ...
   function getClearNextDepth()
   {
      return this.bClearNextDepth;
   }
   function setClearNextDepth(bTrue)
   {
      this.bClearNextDepth = bTrue;
   }
